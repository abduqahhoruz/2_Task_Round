package com.example.a2_task_round
...
class CircleImageView : AppCompatImageView {
    ...
    constructor(context: Context, attrs: AttributeSet, defStyle: Int = 0) : super(context, attrs, defStyle) {
        ...
        mBorderWidth = a.getDimensionPixelSize(R.styleable.CirleImageView_civ_border_width,
            DEFAULT_BORDER_WIDTH
        )
        mBorderColor = a.getColor(R.styleable.CirleImageView_civ_border_color,
            DEFAULT_BORDER_COLOR
        )
        mBorderOverlay = a.getBoolean(R.styleable.CirleImageView_civ_border_overlay,
